...
using AuthorizationServer.WebUI;
...
namespace AuthorizationServer.Application.IntegrationTests
{
    ...
    public class Testing
    {
        ...
        public void RunBeforeAnyTests()
        {
            ...
            var environment = Mock.Of<IWebHostEnvironment>(w => w.EnvironmentName == "Development" && w.ApplicationName == "AuthorizationServer.WebUI");
